      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b">
          <div className="flex items-center flex-wrap gap-1">
            {typeof title === 'string' ? <h2 className="text-lg font-semibold" data-testid="bottom-sheet-title">{title}</h2> : title}
            {subtitle && <div data-testid="bottom-sheet-subtitle">{subtitle}</div>}
          </div>
          <Button
            variant="ghost"
            size="icon"
